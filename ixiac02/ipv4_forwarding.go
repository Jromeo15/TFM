...
var (
	...
	r3Mac      = "02:00:00:00:03:aa"
	r1Ip       = "1.1.1.1"
	r2Ip       = "2.2.2.1"
	r3Ip       = "3.3.3.1"
	r1IpPrefix = uint32(24)
	r2IpPrefix = uint32(24)
	r3IpPrefix = uint32(24)
	r1IpGw     = "1.1.1.2"
	r2IpGw     = "2.2.2.2"
	r3IpGw     = "3.3.3.2"
	pktCount   = 100
...
func newConfig() (gosnappi.GosnappiApi, gosnappi.Config) {
	...
	p3 := config.Ports().Add().SetName("p3").SetLocation(otgPort3)
	...
	r3Ip := r3Eth.Ipv4Addresses().Add().
		SetName("r3Ip").
		SetAddress(r3Ip).
		SetPrefix(r3IpPrefix).
		SetGateway(r3IpGw)

	// create a flow between r1, r2, and r3
	f1 := config.Flows().Add().SetName("r1.v4.r2")
	f1.TxRx().Device().SetTxNames([]string{r1Ip.Name()})
	f1.TxRx().Device().SetRxNames([]string{r2Ip.Name(), r3Ip.Name()})
